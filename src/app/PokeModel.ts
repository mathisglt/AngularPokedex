...
export class Convert {
    public static toPokeModel(json: string): PokeModel {
        return cast(JSON.parse(json), r("PokeModel"));
    }

    public static pokeModelToJson(value: PokeModel): string {
        return JSON.stringify(uncast(value, r("PokeModel")), null, 2);
    }
}
